...
const showRecipe = async ()=>{
    try {
        ...
        const res = await fetch(`https://forkify-api.herokuapp.com/api/v2/recipes/${id}?key=fe453a9e-3b00-4bf9-b388-fee97f43090e`);
...
},{"url:../img/icons.svg":"jJJSm","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc","core-js/stable":"eIyVg","regenerator-runtime/runtime":"cH8Iq"}],"jJJSm":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('S7RoD') + "icons.c097e590.svg";
...
},{}]},["hTbRF","c1VqH"], "c1VqH", "parcelRequire3a11")
